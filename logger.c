...
//	log_buffer_empty(functions,message);
	...
	log_buffer_valid(functions,level,message);
	...
	//log_buffer_size(functions,message);

}

//void log_buffer_size(enum function_type functions)
//{
//	if(functions==all || functions==buffer_size)
//		Send_String_Poll("\n\rCHECK THE BUFFER SIZE\n\r");
//}
...
//		if (message==false)
//		Send_String_Poll("\n\rReceiver data register full\n\r");
//		else
//		Send_String_Poll("\n\rReceiver data register empty\n\r");
//																  //the required data
//	else if(level==debug)
//		Send_String_Poll("\n\rhey\n\r");
//	else

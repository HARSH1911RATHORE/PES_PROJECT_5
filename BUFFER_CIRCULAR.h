...
#define Q_MAX_SIZE (4)       //Define the Size of The circular buffer here
...
extern int Circular_Buffer_Empty(Circilar_Buffer * CB);
extern int Circular_Buffer_Full(Circilar_Buffer * CB);
extern int Circular_Buffer_Size(Circilar_Buffer * CB);
